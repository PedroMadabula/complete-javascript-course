...
//question.forEach((value, key)) => console.log(`This is ${key}, and it's set t0 ${value}`));
...
var Athlete5 = function(name, yearOfBirth, job, olympcGames, medals) {
    Person5.call(this, name, yearOfBirth, job);
    this.olympcGames = olympcGames;
    this.medals = medals;
}
...
class Athlete6 extends Person6 {
    constructor(name, yearOfBirth, job, olympcGames, medals) {
